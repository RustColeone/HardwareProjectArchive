...
namespace EpaperMqtt
{
    public partial class Form1 : Form
    {
        ...
        private void SavewhenExit()
        {
            ...
            PUserID = textBoxUser.Text;
            PClientID = textBoxClientID.Text;
            PBrokerServer = textBoxPCServer.Text;
            Ppublishtopic = textBoxBrokerTopic.Text;
            Pclienttopic = textBoxClientTopic.Text;
            PPort = textBoxPCport.Text;
            ...
            string createText = Password + Environment.NewLine
                ...
                + intopic + Environment.NewLine
                + Port + Environment.NewLine
                + WiFissid + Environment.NewLine
                + WiFipass + Environment.NewLine

                +PPassword + Environment.NewLine
                +PUserID + Environment.NewLine
                +PClientID + Environment.NewLine
                +PBrokerServer + Environment.NewLine
                +Ppublishtopic + Environment.NewLine
                +Pclienttopic  +Environment.NewLine
                +PPort + Environment.NewLine;
        ...
        private void LoadwhenEnter()
        {
            ...
            {    // Open the file to read from.
                ...
                PPassword = strReader.ReadLine();
                PUserID = strReader.ReadLine();
                PClientID = strReader.ReadLine();
                PBrokerServer = strReader.ReadLine();
                Ppublishtopic = strReader.ReadLine();
                Pclienttopic = strReader.ReadLine();
                PPort = strReader.ReadLine();
                ...
                textBoxPassword.Text = PPassword;
                textBoxUser.Text = PUserID;
                textBoxClientID.Text = PClientID;
                textBoxPCServer.Text = PBrokerServer;
                textBoxBrokerTopic.Text = Ppublishtopic;
                textBoxClientTopic.Text = Pclienttopic;
                textBoxPCport.Text = PPort;
            }
        }
        ...
        private void ConnectMqtt()
        {
            ...
            if (Myport.PortIsOpen() == false && internetconnected == 1)
                ...
                textBoxAllStatus.Text = "Serial Port or internet not connected";
            }
            else
            {
                ...
                //wait for return signal//
                int rc;
                do { rc = Myport.setcomstep();
                    Thread.Sleep(10); if (timeup == 1) break;
                } while (rc != 'a' && rc != 'A');
#if (EPD27)
                //     if(rc=='A') textBoxStatus.Text = "Glass 2.7inch ";
                //else textBoxStatus.Text = "Glass missmatch ";
                Update();
#endif
                ...
                else
                {
                    ...
                    textBoxAllStatus.Text = "Mqtt connect failure";
                }
            }
        ...
        private void ConnectWifiESP8266()
        {
            buttonWiFiConnect();
            textBoxStatus.Text = "Internet connected";
            textBoxAllStatus.Text = "Internet connected";
            Update();
            ...
            else
            {
                ...
                textBoxAllStatus.Text = " Internet connect failure";
            }
            if (Mqttconnected == 1)
            {
                TopicUpdata();
                ...
                textBoxAllStatus.Text = " Internet and Mqtt Connected";
                buttonConnectWifi.Text = "ReConnect";
                buttonSendtoEpaper.Enabled = true;
            }
            else
            {
                buttonConnectWifi.Text = "Connect";
                buttonSendtoEpaper.Enabled = false;
            }
        }
        ...
        private void buttonWiFiConnect()
        {
            ...
            if (Myport.PortIsOpen() == false)
                ...
                textBoxAllStatus.Text = "Port Not Open";
            }
            else
            {
