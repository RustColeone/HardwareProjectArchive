...
void nextTetromino() {
  ...
  *z = *t_z;
  switch(tetCurrent) {
      case T_I: tetRows = 4; tetCols = 4; tetData = i; break;
      case T_J: tetRows = 3; tetCols = 3; tetData = j; break;
      case T_L: tetRows = 3; tetCols = 3; tetData = l; break;
      case T_O: tetRows = 3; tetCols = 4; tetData = o; break;
      case T_S: tetRows = 3; tetCols = 3; tetData = s; break;
      case T_T: tetRows = 3; tetCols = 3; tetData = t; break;
      case T_Z: tetRows = 3; tetCols = 3; tetData = z;  break;
  }
  tetCol = 3; 
  tetRow = 17; 
  tetRotation = 0;
